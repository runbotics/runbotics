const excelActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.Excel.InsertColumns.Column.Info': 'Column name e.g. "AZ" or column number "e.g. "25"',
    'Process.Details.Modeler.Actions.Excel.InsertColumns.Amount.Info': 'Number of columns to insert',
    'Process.Details.Modeler.Actions.Excel.InsertColumns.Worksheet.Info': 'Sheet name. Default is currently active sheet',
