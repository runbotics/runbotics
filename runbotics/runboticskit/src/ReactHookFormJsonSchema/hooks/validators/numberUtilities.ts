...
export const getNumberStep = (currentObject: JSONSchemaType): [number | 'any', number | undefined] => {
...
export const getNumberMinimum = (currentObject: JSONSchemaType): number | undefined => {
...
export const getNumberMaximum = (currentObject: JSONSchemaType): number | undefined => {
    const [step] = getNumberStep(currentObject);
...
export const getNumberValidator = (currentObject: JSONSchemaType, required: boolean): RegisterOptions => {
            ...
            multipleOf: (value: string) => {
                if (currentObject.type === 'integer' && value) {
                    return (
                        ...
                        (parseInt(value) % parseInt(currentObject.multipleOf) === 0 || ErrorTypes.multipleOf)
                    );
                } else {
