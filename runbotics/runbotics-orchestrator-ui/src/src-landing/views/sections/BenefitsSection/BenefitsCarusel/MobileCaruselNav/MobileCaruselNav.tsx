...
const MobileCaruselNav: FC<MobileCaruselNavProps> = ({ decrementSlide, incrementSlide, length, currentSlide }) => (
    <div className={styles.root}>
        <CaruselButton direction="backward" onClick={decrementSlide} />
        <Typography variant="body1" className={styles.counter}>
            <span className={styles.counterCurrent}>{currentSlide + 1}</span> / {length}
        </Typography>
