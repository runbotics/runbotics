...
runbotics/runbotics/runbotics-sdk
rushx build

runbotics/runbotics/runbotics-common
rushx build

runbotics/runbotics/runbotics-desktop
rushx start:dev

runbotics/runbotics/runbotics-orchestrator-ui
rushx start

runbotics/runbotics-orchestrator
docker-compose -f src/main/docker/postgresql.yml up -d
./gradlew -x webapp
npm start
