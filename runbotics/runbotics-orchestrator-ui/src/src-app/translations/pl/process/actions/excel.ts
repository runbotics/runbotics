...
const excelActionsTranslations: typeof englishExcelActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.Excel.InsertColumns.Column.Info': 'Nazwa kolumny np "AZ" lub numer kolumny "25".',
    'Process.Details.Modeler.Actions.Excel.InsertColumns.Amount.Info': 'Liczba kolumn do wstawienia.',
    'Process.Details.Modeler.Actions.Excel.InsertColumns.Worksheet.Info': 'Arkusz. Domyślnie obecnie aktywny arkusz.',
