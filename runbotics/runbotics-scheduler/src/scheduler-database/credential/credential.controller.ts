...
export class CredentialController {
  ...
  findAllAccessibleInCollection(@User() user: UserEntity, @Param('collectionId') collectionId: string) {
  ...
  @Get('credentials/:id')
  findOneUserAccessible(@Param('id') id: string, @User() user: UserEntity) {
  ...
  update(@Param('id') id: string, @Body(new ZodValidationPipe(updateCredentialSchema)) credentialDto: UpdateCredentialDto, @User() user: UserEntity) {
  ...
  updateAttribute(@Param('id') id: string, @Param('attributeName') attributeName: string, @Body() attributeDto: UpdateAttributeDto, @User() user: UserEntity) {
