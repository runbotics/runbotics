...
const jiraCloudTranslations: typeof englishJiraCloudActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.JiraCloud.GetUserWorklogs.DatesList': 'Lista dat',
    ...
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectWorklogs.DatesList': 'Lista dat',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectWorklogs.GroupByDay': 'Pogrupuj po dniach',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectWorklogs.Project': 'Klucz projektu',
    ...
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Label': 'Pobierz sprinty projektu',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Origin': 'Origin - Zmienna środowiskowa',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Username': 'Nazwa użytkownika - Zmienna środowiskowa',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Password': 'Hasło - Zmienna środowiskowa',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Project': 'Klucz projektu',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.State': 'Status sprintu',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Output.Info': 'Tablica sprintów projektu',
