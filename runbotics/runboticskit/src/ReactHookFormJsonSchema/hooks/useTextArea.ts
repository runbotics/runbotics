...
import { UseTextAreaParameters, BasicInputReturnType, UseTextAreaReturnType, InputTypes } from './types';
...
export const getTextAreaCustomFields = (baseInput: BasicInputReturnType): UseTextAreaReturnType => {
