...
const excelActionsTranslations: typeof englishExcelActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.Excel.InsertRows.RowsAmount': 'Liczba rzędów do wstawienia',
    'Process.Details.Modeler.Actions.Excel.InsertRows.Row.Info': 'Początkowy numer rzędu, np. 5',
    'Process.Details.Modeler.Actions.Excel.InsertRows.Amount.Info': 'Liczba rzędów do wstawienia, np. 3.',
