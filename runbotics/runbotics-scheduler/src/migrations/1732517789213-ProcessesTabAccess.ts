...
export class ProcessesTabAccess1732517789213 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.manager.getRepository('authority_feature_key').insert({ authority: 'ROLE_ADMIN', feature_key: 'ALL_PROCESSES_READ' });
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.manager.getRepository('authority_feature_key').delete({ authority: 'ROLE_ADMIN', feature_key: 'ALL_PROCESSES_READ' });
