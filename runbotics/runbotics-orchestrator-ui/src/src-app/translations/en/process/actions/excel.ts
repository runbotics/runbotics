const excelActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.Excel.InsertColumns.ColumnsAmount': 'Amount of columns to be inserted',
    ...
    'Process.Details.Modeler.Actions.Excel.Worksheet.Info': 'Sheet name. Default is currently active sheet.',
