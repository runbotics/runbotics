...
import {
    Box,
    FormControl, MenuItem, Pagination, Select, TableCell, TableFooter, TableRow, Typography,
} from '@mui/material';
...
const DataTableFooter: FC<DataTableFooterProps> = ({
    pageCount, pageSize, setPageSize, page, setPage, sx,
}) => {
    ...
    const renderPageSizeMenuItems = () => TABLE_PAGE_SIZES.map((item) => (
                    ...
                    <Box width="100%" display="flex" alignItems="center" position="relative" padding="1.25rem 0">
                        <RowsSelectWrapper>
                            <Typography variant="h6">
                                {translate('Component.Table.RowsPerPage')}
                            </Typography>
