...
function createElementTemplateGroups(
    ...
    return [descriptionGroup, elementTemplateInputParametersGroup, elementTemplateOutputParametersGroup].concat(
        customFieldsGroups,
    );
}
...
function createConnectorTabGroups(element, bpmnFactory, elementRegistry, translate) {
    ...
    return [connectorDetailsGroup, connectorInputParametersGroup, connectorOutputParametersGroup];
}
