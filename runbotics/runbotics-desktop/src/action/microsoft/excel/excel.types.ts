...
export type ExcelSession = (SharePointSession | OneDriveSession) & CredentialData;
...
export type ExcelSessionInfo = (OneDriveSessionInfo | SharePointSessionInfo) & CredentialData;
