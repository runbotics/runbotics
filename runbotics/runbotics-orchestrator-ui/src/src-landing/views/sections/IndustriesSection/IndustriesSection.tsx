...
import { INDUSTRIES_TITLE_ID } from '#src-landing/views/sections/IndustriesSection/IndustriesSection.utils';
...
const IndustriesSection = () => {
    ...
    return (
        <section
            ...
            id={INDUSTRY_SECTORS_SECTION_ID}
            aria-labelledby={INDUSTRIES_TITLE_ID}
        >
