...
import static com.runbotics.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import com.runbotics.web.rest.vm.KeyAndPasswordVM;
import com.runbotics.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(getAuthority(AuthoritiesConstants.ADMIN)));
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(getAuthority(AuthoritiesConstants.ADMIN)));
    ...
    private AuthorityDTO getAuthority(String role) {
