...
const modalsActionsTranslations: typeof englishModalsActionsTranslations = {
    ...
    'Tenants.Actions.Modals.DeleteModal.Message.Fail.BadTenantID': 'Nie można znaleźć klienta o podanym identyfikatorze',
    'Tenants.Actions.Modals.DeleteModal.Message.Fail.RelatedTenant': 'Nie można usunąć klienta powiązanego z innymi zasobami',
