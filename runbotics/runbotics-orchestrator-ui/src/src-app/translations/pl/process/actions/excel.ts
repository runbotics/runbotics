...
const excelActionsTranslations: typeof englishExcelActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.Excel.SetFirstEmptyRow.StartingColumn': 'Początkowa kolumna wyszukiwania (domyślnie: A)',
    'Process.Details.Modeler.Actions.Excel.SetFirstEmptyRow.StartingRow': 'Początkowy wiersz wyszukiwania (domyślnie: 1)',
    'Process.Details.Modeler.Actions.Excel.SetFirstEmptyRow.Values': 'Tablica tablic z wartościami do ustawienia (np. [[#{numerZadania}, "WYKONANE", 795], [#{numerInnegoZadania}, "DO ZROBIENIA", 1200]]).',
