...
const COMMON_PROCESS_INSTANCE_FIELDS = ['input', 'error', 'root_process_instance_id', 'orchestrator_process_instance_id', 'trigger', 'trigger_data', 'step','user_id', 'process_id', 'bot_id'];
...
export const getProcessInstanceUpdateFieldsByStatus = (
    ...
    switch(newStatus) {
        ...
        default: {
            ...
            return ['status', ...COMMON_PROCESS_INSTANCE_FIELDS];
        }
    }
};
