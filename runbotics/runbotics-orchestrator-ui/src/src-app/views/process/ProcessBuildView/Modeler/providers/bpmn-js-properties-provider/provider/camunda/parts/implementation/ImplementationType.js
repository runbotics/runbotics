...
var DEFAULT_DELEGATE_PROPS = ['runbotics', 'class', 'expression', 'delegateExpression'];
...
module.exports = function (element, bpmnFactory, options, translate) {
    var DEFAULT_OPTIONS = [
        { value: 'runbotics', name: 'runbotics' },
                ...
                if (hasServiceTaskLikeSupport) {
                    ...
                    if (newType === 'connector') {
                        ...
                        if (!extensionElements) {
                            ...
                            commands.push(
                                cmdHelper.updateBusinessObject(element, bo, { extensionElements: extensionElements }),
                            );
                        }
