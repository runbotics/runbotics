...
import {
    ProcessInstanceEventsDetailsHeader, ProcessInstanceEventsDetailsTable,
    AccordionHeader, RoundedAccordion,
} from '.';
...
const sortByFinished = (
    aEvent: IProcessInstanceEvent, bEvent: IProcessInstanceEvent,
...
const ProcessInstanceEventsDetails: VFC<ProcessInstanceEventsDetailsProps> = ({ processInstanceId }) => {
    ...
    const getActiveProcessInstanceEventsIfMatch = () => (processInstanceId === active.processInstance?.id
    ...
    useEffect(() => {
        if (processInstanceId) {
            dispatch(processInstanceEventActions.getProcessInstanceEvents({ processInstanceId }));
        }
    }, [processInstanceId]);
