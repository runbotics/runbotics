  ...
  return (
    <div>
      <h2 id="action-heading" data-cy="ActionHeading">
        <Translate contentKey="runboticsApp.action.home.title">Actions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="runboticsApp.action.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="runboticsApp.action.home.createLabel">Create new Action</Translate>
          </Link>
        </div>
      </h2>
        ...
        {actionList && actionList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="runboticsApp.action.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('label')}>
                  <Translate contentKey="runboticsApp.action.label">Label</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('script')}>
                  <Translate contentKey="runboticsApp.action.script">Script</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('form')}>
                  <Translate contentKey="runboticsApp.action.form">Form</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="runboticsApp.action.home.notFound">No Actions found</Translate>
            </div>
          )
        )}
      </div>
