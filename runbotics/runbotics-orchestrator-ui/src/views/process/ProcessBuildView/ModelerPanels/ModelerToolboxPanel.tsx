...
const ModelerToolboxPanel: FC<ModelerToolboxPanelProps> = ({ onCenter, onZoomIn, onZoomOut, onRedo, onUndo }) => {
    const { commandStackIdx, commandStackSize } = useSelector((state) => state.process.modeler);
    const canRedo = commandStackIdx + 1 === commandStackSize;
    const canUndo = !(commandStackIdx + 1 > 0);
