...
export const getProcessInstanceLoopEvents = createAsyncThunk<IProcessInstanceLoopEvent[], { loopId: string, nestedIteration?: number }>(
    'processInstanceEvent/getBotProcessInstanceLoopEvents',
    ({ loopId }) => Axios.get<IProcessInstanceLoopEvent[]>(
