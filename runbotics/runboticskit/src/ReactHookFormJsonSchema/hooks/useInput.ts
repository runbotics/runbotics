import { UseInputParameters, BasicInputReturnType, UseRawInputReturnType } from './types';
import { getRawInputCustomFields } from './useRawInput';
import { useGenericInput } from './useGenericInput';

export const getInputCustomFields = (baseObject: BasicInputReturnType): UseRawInputReturnType => {
    ...
    } else if (currentObject.type === 'integer' || currentObject.type === 'number') {
        inputType = 'number';
    }
