...
const excelActionsTranslations: typeof englishExcelActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.Excel.CellValues.StartColumn.Info': 'Kolumna, od której rozpocznie się wstawianie wartości. Domyślnie A',
    'Process.Details.Modeler.Actions.Excel.CellValues.StartRow.Info': 'Wiersz, od którego rozpocznie się wstawianie wartości. Domyślnie 1',
    'Process.Details.Modeler.Actions.Excel.SetFirstEmptyRow.Label': 'Wstaw do pierwszego pustego wiersza',
    'Process.Details.Modeler.Actions.Excel.SetFirstEmptyRow.StartColumn.Info': 'Początkowa kolumna wyszukiwania. Domyślnie A',
    'Process.Details.Modeler.Actions.Excel.SetFirstEmptyRow.StartRow.Info': 'Początkowy wiersz wyszukiwania. Domyślnie 1',
    'Process.Details.Modeler.Actions.Excel.SetFirstEmptyRow.Values': 'Wartości do ustawienia np. [["A", "GOTOWE", 795], ["B", "W TRAKCIE", 1200]].',
    'Process.Details.Modeler.Actions.Excel.SetFirstEmptyRow.Values.Info': 'Lista wierszy, a każdy wiersz to lista wartości do ustawienia',
