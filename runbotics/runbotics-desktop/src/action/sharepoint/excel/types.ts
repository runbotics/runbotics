...
export type FileActionRequest =
    ...
    | DesktopRunRequest<'sharepointExcel.switchWorksheet', SharepointExcelSwitchWorksheetActionInput>;
...
export interface SharepointExcelSwitchWorksheetActionInput {
    worksheetName: string;
}
export type SharepointExcelSwitchWorksheetActionOutput = void;
