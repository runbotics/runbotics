...
const excelActionsTranslations: typeof englishExcelActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.Excel.DeleteRows.Label': 'Usuń rzędy',
    'Process.Details.Modeler.Actions.Excel.DeleteRows.RowRange': 'Zasięg rzędów',
    'Process.Details.Modeler.Actions.Excel.DeleteRows.RowRange.Info': 'Rząd, przedział lub lista np. "5", "1:4" or ["5", "2", "1"].',
