export const credentials = {
    ...
    'Credential.Add.Save': 'Save credential',
    ...
    'Credential.Details.Dislaimer.Label': 'Disclaimer: ',
    'Credential.Details.Dislaimer.Text': 'All credentials must be contained in collections for bots to use them. Only the collection owner can edit credential and share it with other users.',
