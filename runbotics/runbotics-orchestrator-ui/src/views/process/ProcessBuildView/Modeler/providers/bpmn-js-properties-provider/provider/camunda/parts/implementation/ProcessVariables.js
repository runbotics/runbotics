...
module.exports = function (element, translate) {
        ...
        return flatten(
            map(variables, function (variable) {
                ...
                variableEntries.push({
                    ...
                    html: createdInHtml,
                    cssClasses: ['bpp-process-variables', 'bpp-process-variables__created-in'],
                    show: function () {
                        return isOpen();
                    },
                });
    ...
    var description = entryFieldDescription(
        translate,
        translate('Available process variables, identified in the diagram.'),
    );

    entries.push({
        id: 'process-variables-description',
        html: description,
        cssClasses: ['bpp-process-variables', 'bpp-process-variables__description'],
    });
    ...
    if (keys(byScope).length > 1) {
        ...
        forEach(reverse(keys(byScope)), function (scope) {
            ...
            entries.push({
                ...
                cssClasses: ['bpp-process-variables', 'bpp-process-variables__scope-title', 'bpp-collapsible-break'],
            });
