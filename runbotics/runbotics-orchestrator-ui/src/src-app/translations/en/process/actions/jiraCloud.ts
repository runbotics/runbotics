const jiraCloudActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Label': 'Get Project Sprints',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Origin': 'Origin - Environment Variable',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Username': 'Username - Environment Variable',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Password': 'Password - Environment Variable',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Project': 'Project key',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.State': 'State of the sprint',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectSprints.Output.Info': 'Array of project\'s sprints',
