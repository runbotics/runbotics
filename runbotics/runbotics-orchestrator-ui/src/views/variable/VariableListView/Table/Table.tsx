...
const Table: FunctionComponent<TableProps> = ({ className, setVariableDetailState }) => {
    ...
    const hasAccessToDelete = useFeatureKey([FeatureKey.GLOBAL_VARIABLE_DELETE]);
    const hasAccessToEdit = useFeatureKey([FeatureKey.GLOBAL_VARIABLE_EDIT]);
    ...
    const columns = useColumns({
        onDelete, onEdit, hasAccessToDelete, hasAccessToEdit,
    });
    ...
    return (
        <div>
            ...
            <If condition={hasAccessToDelete}>
