...
export default class SharepointExcelActionHandler extends StatelessActionHandler {
    ...
    async switchWorksheet(
        input: SharepointTypes.SharepointExcelSwitchWorksheetActionInput
    ): Promise<SharepointTypes.SharepointExcelSwitchWorksheetActionOutput> {
        return this.excelService.switchWorksheet(input.worksheetName);
    }
    ...
    async run(request: SharepointTypes.FileActionRequest) {
        switch (request.script) {
            ...
            case 'sharepointExcel.switchWorksheet':
                return this.switchWorksheet(request.input);
