const jiraCloudActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.JiraCloud.GetUserWorklogs.DatesList': 'Dates List',
    ...
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectWorklogs.DatesList': 'Dates List',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectWorklogs.GroupByDay': 'Group by day',
    'Process.Details.Modeler.Actions.JiraCloud.GetProjectWorklogs.Project': 'Project key',
    ...
    'Process.Details.Modeler.Actions.JiraCloud.GetSprintTasks.DatesList': 'Dates List',
    'Process.Details.Modeler.Actions.JiraCloud.GetSprintTasks.Sprint': 'Sprint name',
    'Process.Details.Modeler.Actions.JiraCloud.GetSprintTasks.Email': 'Assignee email',
    'Process.Details.Modeler.Actions.JiraCloud.GetSprintTasks.Fields': 'Additional fields',
