...
export class ProcessCollectionNewTables1750750975953 implements MigrationInterface {
    name = 'ProcessCollectionNewTables1750750975953';
      ...
      $$;`);
        await queryRunner.query(`CREATE TABLE "scheduler"."process_collection_user"
                                 (
                                     ...
                                     "processCollectionId" integer                                                   NOT NULL,
        ...
        await queryRunner.query(`ALTER TABLE "scheduler"."process_collection"
            ADD CONSTRAINT "FK_8e9bec83e0f75715c43950ce006" FOREIGN KEY ("created_by") REFERENCES "jhi_user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "scheduler"."process_collection"
            ADD CONSTRAINT "FK_de0aba3344d22a98f3a3820081f" FOREIGN KEY ("tenant_id") REFERENCES "tenant" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "scheduler"."process_collection"
