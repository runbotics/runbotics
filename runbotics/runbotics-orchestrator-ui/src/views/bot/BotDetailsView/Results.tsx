...
const Results: FC = () => {
    ...
    const hasAccessToConsoleTab = useFeatureKey([FeatureKey.BOT_LOG_READ]);
    const hasAccessToLogsTab = useFeatureKey([FeatureKey.BOT_HISTORY_READ]);

    const currentTab = useMemo(() => {
        if (hasAccessToLogsTab) {
    ...
    const tabs = useMemo(() => {
        ...
        return tabsToReturn;
    }, [hasAccessToConsoleTab, hasAccessToLogsTab]);
