            ...
            <StyledGridContainer container rowSpacing={2}>
                ...
                <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'flex-end', alignSelf: 'center' }}>
                    <If condition={!isEditMode}>
                        <Fade in={!isEditMode}>
                            <Button size="small" onClick={handleEdit} sx={{ marginRight: '8px', color: grey[700] }}>
                                <AttributeIcon>
                                    <EditIcon />
                                </AttributeIcon>
                                <Typography variant="h5">{translate('Credential.Attribute.Edit.Edit').toUpperCase()}</Typography>
                            </Button>
                        </Fade>
                    </If>
                </Grid>
                <Collapse in={isEditMode} orientation="vertical" sx={{ width: '100%' }}>
                    <Grid item xs={12}>
                        ...
                        <StyledGridContainer container justifyContent="space-between">
                            <Grid item>
                                <Button size="small" onClick={handleCancel} sx={{ padding: 0, color: grey[700] }}>
                                    <AttributeIcon>
                                        <ClearIcon />
                                    </AttributeIcon>
