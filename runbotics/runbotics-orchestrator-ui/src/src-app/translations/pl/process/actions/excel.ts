...
const excelActionsTranslations: typeof englishExcelActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.Excel.SetCells.CellValues': 'Wartości do ustawienia np. [["C3", "D3", "E3"], ["C4", "D4", "E4"]]',
    'Process.Details.Modeler.Actions.Excel.SetCells.CellValues.Info': 'Lista wierszy, a każdy wiersz to lista wartości do ustawienia. Dla null zawartość komórki pozostanie nie zmieniona.',
    ...
    'Process.Details.Modeler.Actions.Excel.DeleteColumns.ColumnRange': 'Kolumna, przedział lub tablica np. "G", "C:F" lub ["C", "E", "H"]',
