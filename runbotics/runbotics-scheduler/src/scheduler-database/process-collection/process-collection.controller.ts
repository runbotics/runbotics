...
export class ProcessCollectionController {
    ...
    // ): Promise<{ breadCrumbs?: ProcessCollectionDto[]; childrenCollections: ProcessCollectionDto[] }> {
    //     if (parentId) {
    ...
    //     }
    //     const rootChildren = await this.processCollectionService.getChildrenCollectionsByRoot(user, parentId);

    //     return { childrenCollections: rootChildren };
    // }
    ...
    async delete(
        ...
        this.processCollectionService.delete(id, user);
    }
}
