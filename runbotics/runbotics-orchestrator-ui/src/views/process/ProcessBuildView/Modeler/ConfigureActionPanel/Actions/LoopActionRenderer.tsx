...
const LoopActionRenderer: FC = () => {
    ...
    const isLoopElement = (element: unknown): element is BpmnSubProcess => (element as BpmnSubProcess)?.businessObject?.loopCharacteristics !== undefined;
    ...
    const defaultFormData = React.useMemo(() => {
        ...
        const defaultParameters = {
            input: {
                iterations: '', loopType: 'Repeat', elementVariable: '', collection: '',
            },
            output: {},
        };
