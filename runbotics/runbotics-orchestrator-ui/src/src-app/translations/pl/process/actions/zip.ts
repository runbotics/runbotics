...
const zipTranslations: typeof englishZipTranslations = {
    'Process.Details.Modeler.Actions.Zip.UnzipFile.Label': 'Rozpakuj archiwum',
    'Process.Details.Modeler.Actions.Zip.Unzip.Path': 'Ścieżka',
    'Process.Details.Modeler.Actions.Zip.Unzip.Name': 'Nazwa',
