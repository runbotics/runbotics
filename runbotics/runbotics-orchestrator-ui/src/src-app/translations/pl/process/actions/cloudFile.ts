...
const cloudFileActionsTranslations: typeof englishCloudFileActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.CloudFile.ItemName': 'Nazwa elementu',
    ...
    'Process.Details.Modeler.Actions.CloudFile.Upload.LocalParentFolderPath': 'Ścieżka do folderu przesyłanego pliku',
