...
import { getObjectFromForm, concatFormPointer, getAnnotatedSchemaFromPointer, getSplitPointer } from './logic';
import { useFormContext } from '../components';

const useAnnotatedSchemaFromPointer = (path: string, data: JSONSchemaType): JSONSubSchemaInfo => {
...
const getDataFromPointer = (pointer: string, data: JSONSchemaType): undefined | string => {
    ...
    return splitPointer
        .reduce(
            (currentContext, node: string) => {
                ...
                return {
                    currentData: currentContext.currentData ? currentContext.currentData[node] : undefined,
                    insideProperties: true,
                };
            },
...
export { useObjectFromForm, concatFormPointer, useAnnotatedSchemaFromPointer, getDataFromPointer };
