const excelActionsTranslations = {
    ...
    'Process.Details.Modeler.Actions.Excel.ExportHtmlTable.FilePath': 'File path',
    ...
    'Process.Details.Modeler.Actions.Excel.ExportHtmlTable.FilePath.Info': 'Absolute path to file, e.g. C:/RunBotics/excel/example.xlsx.',
