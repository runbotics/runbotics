import englishTableListTranslations from '#src-app/translations/en/tenants/list/table';

const tableListTranslations: typeof englishTableListTranslations = {
    'Tenants.List.Table.Columns.Name': 'Nazwa',
    'Tenants.List.Table.Columns.CreatedBy': 'Stworzona przez',
